...
export default function ReportSharing({ filters, onShare, className }: ReportSharingProps) {
  ...
  const handleExport = (format: 'csv' | 'excel' | 'pdf' | 'png') => {
    if (format === 'csv' || format === 'excel') {
      ...
      // Handle PDF and PNG exports (would integrate with chart libraries)
          ...
          <TabsContent value="export" className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <span>CSV</span>
                <span className="text-xs text-muted-foreground">טבלת נתונים</span>
              </Button>
              ...
              >
                <FileText className="h-6 w-6" />
                <span>PDF</span>
                <span className="text-xs text-muted-foreground">דוח מעוצב</span>
              </Button>
              ...
              >
                ...
                <span>תמונה</span>
                <span className="text-xs text-muted-foreground">תרשימים</span>
              </Button>
            </div>
