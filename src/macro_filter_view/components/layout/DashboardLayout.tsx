...
import { Filter, LayoutGrid, Table, List, Settings } from 'lucide-react';
...
import ReportSharing from '../shared/ReportSharing';
...
export default function DashboardLayout({ 
  ...
  const [localFilters, setLocalFilters] = useState<DashboardFilters>(propFilters || getDefaultFilters());
